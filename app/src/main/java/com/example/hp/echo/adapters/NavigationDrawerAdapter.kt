...
import com.example.hp.echo.fragments.AboutUsFragment
import com.example.hp.echo.fragments.FavouriteFragment
import com.example.hp.echo.fragments.MainScreenFragment
import com.example.hp.echo.fragments.Settingsfragment
   ...
   var getImages : IntArray?=null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NavViewHolder {
       var  itemView = LayoutInflater.from(parent?.context)
            .inflate(R.layout.raw_custom_navigationdrawer,parent,false)
